...
">Löschen</a></td>
		...
		<tr><td>Absender</td><td><?php if ($this->_tpl_vars['mail']['from_id'] == -1): ?><?php echo $this->_tpl_vars['mail']['from_username']; ?>
<?php else: ?><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
">Löschen</a></td>
		...
		<td align="center"><?php if ($this->_tpl_vars['mail']['from_id'] == -1): ?>Absender blockieren<?php else: ?><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=mail&amp;mode=block&amp;action=block_id&amp;id=<?php echo $this->_tpl_vars['mail']['from_id']; ?>
&amp;h=<?php echo $this->_tpl_vars['hkey']; ?>
">Absender blockieren</a><?php endif; ?></td>
		</tr>
		</table><br />
	<?php endif; ?>
<?php endif; ?>