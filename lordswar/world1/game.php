...
// print_r(time());
// print("\nworld_begin\n");
// print_r($config['world_begin']);
// print("\nkkk\n");
// die(print_r(time() - $config['world_begin']));
// $tpl->assign("worldtime", date("G:i:s", (time() - $config['world_begin'])*40));
$wt = unreal_time();
// print_r($wt);
// die('kk');
// $tpl->assign("worldtime", "$wt[hour]:$wt[min]:$wt[sec]");
// $tpl->assign("worlddate", date("d/m/Y"));
$tpl->assign("worldtime", $wt);
