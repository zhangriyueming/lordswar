...
$config['main_site'] = 'http://127.0.0.1.xip.io';
$config['cdn'] = 'http://127.0.0.1.xip.io/assets'; // Image / JS directory
$config['forum'] = 'http://forum.127.0.0.1.xip.io'; // Link to your forum
