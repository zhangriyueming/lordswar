	...
	<tr>
		<td valign="top" width="50%">
			<table class="vis" width="100%">
				<tr><th colspan="3">{$lang->get('Convites_sent')}</th></tr>
				...
				<tr>
					...
					<td>{$arr.time}</td>
					<td><a href="game.php?village={$village.id}&amp;screen=ally&amp;mode=invite&amp;action=cancel_invitation&amp;id={$id}&amp;h={$hkey}">{$lang->get('Cancelar')}</a></td>
				</tr>
				{/foreach}
			</table>
		</td>
		<td valign="top" width="50%">
			<form action="game.php?village={$village.id}&amp;screen=ally&amp;action=invite&amp;mode=invite&amp;action=invite&amp;h={$hkey}" method="post">
				<table class="vis" width="100%">
					<tr><th colspan="3">{$lang->get('Convidar')}</th></tr>
					<tr><td>{$lang->get('jogador')}:</td>
