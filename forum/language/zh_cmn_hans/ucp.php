...
$lang = array_merge($lang, array(
	...
	<br />
	您的密码在软件中以加密形式存在 (不可逆算法)， 所以它是安全的。 但是， 我们希望您不要在不同的网站上使用相同的用户名和密码。 您的密码是你在  “%1$s” 上访问您的帐号的唯一途径， 所以请谨慎保管您的密码并且在任何情况下不会有任何与 “%1$s” 相关的个人或单位， 或者 phpBB，  或者任何第三方组织需要您提供您的密码。 如果您不慎遗失您的密码， 您可以使用 phpBB 软件提供的 “我忘记了自己的密码” 功能。 在找回密码的过程中您将要回答您的用户名和您的email， 而后 phpBB 软件将会提供一个新的密码让您取回帐号。<br />
	',
));
...
$lang = array_merge($lang, array(
	...
	'LOGIN_LINK'					=> '用你的论坛账号连接或注册你的外部服务账户',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> '你有 %d 私信已挂起，因为文件夹已满。',
		2	=> '你有 %d 私信已挂起，因为文件夹已满。',
	),
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> '"自动登录"之  登录密钥自动记住你当你访问论坛时。如果你登出，"自动登录"之登录密钥只在电脑上登出时删除。这里你可以看到记住的在其他电脑上创建的登录密钥。',
	...
	'GROUPS_EXPLAIN'	=> '用户组设置使管理员更好的管理用户。您会处于一个默认的组中。组定义将决定您对于其他用户的显示信息，例如您的用户名颜色，头像，级别等等。你可以改变您的默认组，但是这取决于管理员的设置。您也可能被放入或加入其他组。一些用户组将会具有额外的权限访问更多的区域。',
	'GROUP_LEADER'		=> '组领导',
	'GROUP_MEMBER'		=> '组成员',
	'GROUP_PENDING'		=> '待批准的组',
