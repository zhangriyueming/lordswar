...
$lang = array_merge($lang, array(
	...
	'SITE_HOME_TEXT_EXPLAIN'		=> '此文本在论坛导航中将显示为一个链接指向你的网站主页。如果不指定，将默认显示为“首页”。',
	'SITE_HOME_URL'					=> '主站URL',
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL'					=> '顶帖间隔',
	'BUMP_INTERVAL_EXPLAIN'			=> '主题中最后一个帖子发表到关闭回复的分钟数、小时数或者天数, 设定为 0 则关闭回复。',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> '如果禁用，论坛将不会发送任何 email。<em>注意会员激活需要启用此项功能。如果当前设定为会员自行激活和管理员激活，则停用此项功能将使会员无需激活。</em>',
...
// Jabber settings
$lang = array_merge($lang, array(
	'ACP_JABBER_SETTINGS_EXPLAIN'	=> '这里您可以启用并控制用户使用 Jabber 发送及时消息和论坛通知。Jabber 是任何人都可以使用的开放协议。一些 Jabber 服务器提供允许您联系其他网络用户的通道。并非所有的服务器都提供这样的通道，协议上的变化将使得操作失败。请确认输入的是已经注册的帐号信息，phpBB 将会使用你这里输入的数据。',
