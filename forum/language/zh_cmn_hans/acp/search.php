...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_MYSQL_NOT_SUPPORTED'				=> 'MySQL 全文索引只能用于 MyISAM 或 InnoDB 表。需要 MySQL 5.6.4 或更新版本来在 InnoDB 表中全文索引。',
	...
	'FULLTEXT_SPHINX_DATA_PATH_EXPLAIN'		=> '它将被用来储存索引和日志文件，你应该创建这个目录在 web 访问目录外面。(应该有一个结尾斜杠)',
	...
	'FULLTEXT_SPHINX_INDEXER_MEM_LIMIT_EXPLAIN'	=> '此数应该总是低于你机器的可用 RAM，如果你遇到周期性的性能问题，可能是由于索引器消耗太多资源，降低索引器的可用内存可以解决此问题。',
	...
	'FULLTEXT_SPHINX_CONFIG_FILE_EXPLAIN'	=> '生成的内容是 Sphinx 配置文件，需要粘贴到 Sphinx.conf，用于 Sphinx 搜索进程。替换 [dbuser] 和 [dbpassword] 占位符用你的数据库帐号密码。',
