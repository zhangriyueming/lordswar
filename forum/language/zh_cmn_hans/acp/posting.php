...
$lang = array_merge($lang, array(
	...
	'HTML_REPLACEMENT_EXPLAIN'		=> '这里您可以定义默认的 HTML 替换代码 (每个模板可以使用它自己的替换代码)。不要忘记放回你上面使用的标记!',
	...
	'tokens'	=>	array(
		...
		'RELATIVE_URL'	=> '相对 URL。您可以使用这个来匹配部分 URL，但是注意: 一个完整的 URL是一个有效的相对 URL。当你想使用相对 URL时,使用 LOCAL_URL 标记。',
