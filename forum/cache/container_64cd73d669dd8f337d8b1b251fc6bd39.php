...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('tribalwars_db_1', 'root', '96kw9o69Q6', 'tribalwars_forum', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbhost' => 'tribalwars_db_1',
            'dbal.dbuser' => 'root',
            'dbal.dbpasswd' => '96kw9o69Q6',
            'dbal.dbname' => 'tribalwars_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
